 ...
 * @author misa
 */
@Named(value = "ficheIntervenantMB")
@ViewScoped
public class FicheIntervenantMB implements Serializable {
    ...
    /**
     * Creates a new instance of FicheIntervenantMB
     */
    public FicheIntervenantMB() {
    }
